...
public class GraveTokenScreen extends HandledScreen<GraveTokenScreenHandler>
{
    private static final Identifier TEXTURE = Identifier.ofDefault("textures/gui/container/generic_54.png");
    private final int rows;

    public GraveTokenScreen(GraveTokenScreenHandler handler, PlayerInventory inventory, Text title)
    {
